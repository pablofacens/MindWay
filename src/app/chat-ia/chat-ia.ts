  ...
  template: `
    <div class="chat-container" [class.chat-container--aberto]="aberto()">
      ...
      <button 
        ...
        (click)="toggleChat()"
        [attr.aria-label]="aberto() ? 'Fechar a Luna' : 'Abrir a Luna'"
        ...
        <div class="chat__janela">
          ...
          <header class="chat__cabecalho">
            <div class="chat__titulo">
              ...
              <div>
                ...
                <p class="chat__status">{{ carregando() ? 'Respondendo...' : 'Olá — pronta pra ajudar!' }}</p>
              </div>
            </div>
            <button 
              type="button"
              ...
              @if (carregando()) {
                <div class="mensagem">
                  <div class="mensagem__bolha mensagem__bolha--carregando">
                    <div class="digitando" aria-hidden="true">
                      <span></span>
                      <span></span>
                      <span></span>
                    </div>
          ...
          <form class="chat__form" (submit)="enviar($event)">
            <input 
              ...
              name="pergunta"
              placeholder="Escreva aqui — por exemplo: 'Onde tem estação de bike?'."
              [disabled]="carregando()"
              #inputChat>
            <button 
              type="submit"
...
export class ChatIAComponent {
    ...
    this.geminiService.perguntar(pergunta, contexto).subscribe({
      ...
      error: (erro) => {
        ...
        this.mensagens.update(msgs => [
          ...msgs,
          {
            texto: 'Poxa, algo deu errado ao buscar a resposta. Quer tentar novamente?',
            usuario: false,
            timestamp: new Date(),
          }
        ]);
  ...
  limparConversa(): void {
    if (confirm('Tem certeza que quer apagar toda a conversa?')) {
      this.mensagens.set([]);
    }
  }
